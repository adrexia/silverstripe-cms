<div class="cms-tree-view-modes">
	...
	<div class="checkboxAboveTree">
		...
		<label for="view-mode-draggable"><% _t("CMSSiteTreeFilter_ChangedPages.ENABLEDRAGGING","Drag'n'drop") %></label>
	</div>
	<% end_if %>
	<div>
		<input type="radio" name="view-mode" class="view-mode" value="multiselect" id="view-mode-multiselect" />
		<label for="view-mode-multiselect"><% _t("CMSSiteTreeFilter_ChangedPages.MULTISELECT","Multi-selection") %></label>
	</div>
</div>
